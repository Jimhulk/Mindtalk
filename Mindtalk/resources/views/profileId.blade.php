...
@section('content')
    <div class="window">
        ...
        <table>
            <tr>
                <td><strong>Name:</strong> {{ $profile->fname }} {{ $profile->lname }}</td>
            </tr>
            <tr>
                <td><strong>Email:</strong> {{ $profile->email }}</td>
            </tr>
            <tr>
                <td><strong>Username:</strong> {{ $profile->username }}</td>
            </tr>
            <tr>
                <td><strong>Number of posts:</strong> {{ $profile->num_posts }} </td>
            </tr>
        </table>
        <br>
        ...
        <div style="text-align: right;margin-bottom: 3em;">
            <?php
                ...
                if(count($all) > 5){
                    echo "Pages : ";
                    if( !(($num-1) == -1) ){
                        echo "<a style=\"all: revert;\" href=\"/Mindtalk/public/profile/".$profile->username."/".($num-1)."\">"."<text> < </text>"."</a>";
                    }
                    ...
                    echo "<a style=\"all: revert;\" href=\"/Mindtalk/public/profile/".$profile->username."/".(0)."\">"."<text> 0 </text>"."</a>";
                    //echo "<a style=\"all: revert;\" href=\"/Mindtalk/public/searchPost/".($num-1)."\">"."<text> as </text>"."</a>";
                    echo "...";
                    echo "<a style=\"all: revert;\" href=\"/Mindtalk/public/profile/".$profile->username."/".($i-1)."\">"."<text> ".($i-1)." </text>"."</a>";
