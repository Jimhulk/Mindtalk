        ...
        <?php
            if(false){
                ...
                if(count($all) > 5){
                    echo "Pages : ";
                    if( !(($num-1) == -1) ){
                        echo "<a style=\"all: revert;\" href=\"/Mindtalk/public/searchPost/filter".($num-1)."\">"."<text> < </text>"."</a>";
                    }
                    ...
                    echo "<a style=\"all: revert;\" href=\"/Mindtalk/public/searchPost/filter".(0)."\">"."<text> 0 </text>"."</a>";
                    //echo "<a style=\"all: revert;\" href=\"/Mindtalk/public/searchPost/".($num-1)."\">"."<text> as </text>"."</a>";
                    echo "...";
                    echo "<a style=\"all: revert;\" href=\"/Mindtalk/public/searchPost/filter".($i-1)."\">"."<text> ".($i-1)." </text>"."</a>";
